...
```{r}
knnreg_model1 <- knnreg(x = train_diamonds[,-7], test = train_diamonds[,-7], y = train_diamonds$price, k = 5)
...
- Linear models (can include interactions and non-linear terms)
- KNN reg package, use KNNreg function in caret
- neural network (use as normal)
- decision tree (regression trees), package CART or PARTYCIT RPART <- do later
- SVM (support vector machines) (try to use as normal)
- random forest for continuous data, RPART or CART <- do later
