...
Before moving to the analysis of the data set, we cleaned the data to prepare it for regression. Cut, color, and clarity were ordinal factors. We decided to change cut, color, and clarity to be factors which are not ordered. All variables except for price were normalized.
...
m <- train(default ~ ., data = credit, method = "knn",
           metric = "Kappa",
           trControl = ctrl,
           tuneGrid = grid)
m
